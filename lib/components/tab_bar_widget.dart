          ...
          children: [
            ...
            SizedBox(
              ...
              child: const TabBarView(children: [
                HomeTabView(recipe: 'breakfast'),
                HomeTabView(recipe: 'lunch'),
                HomeTabView(recipe: 'dinner'),
                HomeTabView(recipe: 'quick'),
              ]),
            )
          ],
        ));
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: Padding(
          ...
          child:
              Center(child: Text(title, style: const TextStyle(fontSize: 9.8))),
        ));
  }
}
...
class HomeTabView extends StatelessWidget {
  final String recipe;
  const HomeTabView({super.key, required this.recipe});
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Text(
                                "Calories: ${calories.toString()}. ${time.toString()}",
                                style: TextStyle(
